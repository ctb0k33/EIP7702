...
const NONCE_TRACKER_CONTRACT: any = process.env.NONCE_TRACKER_CONTRACT;


export {USER_ADDRESS, RECIPIENT_ADDRESS, NFT_CONTRACT_ADDRESS, PROVIDER, CHAIN_ID, GAS_SPONSOR_CONTRACT,USER_PRIVATE_KEY,SPONSOR_PRIVATE_KEY,SPONSOR_ADDRESS, NONCE_TRACKER_CONTRACT};